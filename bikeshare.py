...
def get_filters():
    ...
    """Prompt the user to enter which of the cities they would like to see and make it case insensitive as well as while loop to handle invalid inputs"""
...
def main():
    while True:
        ...
        the user says no or if there is no more data to show"""
